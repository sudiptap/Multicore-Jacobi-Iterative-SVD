...
from results import *
df = pd.DataFrame(results, columns=['solver', 'n', 'tau', 'threads', 'time', 'update'])
...
plot(update_plot, 'updates', 'Number of updates', 'Matrix size', 'time', 'n')
plot(time_plot, 'timing', 'Time taken', 'Matrix size', 'update', 'n')
