#ifndef __JACOBI_INDEPENDENT_H_
#define __JACOBI_INDEPENDENT_H_

#include "jacobi_svd.hpp"

class JacobiIndependent : public SVDecomposer<JacobiIndependent> {
  private:

  public:

    JacobiIndependent(gsl_matrix *M, Params &params):
      SVDecomposer("JacobiIndependent", M, params) {
      }
    ~JacobiIndependent() {
    }
